defmodule Peggy.Accounts.User do
  use Ecto.Schema
  ...
  def profile_changeset(user, attrs) do
    user
    |> cast(attrs, [:locale, :timezone])
    |> validate_required([:locale, :timezone])
  ...
  """
  def valid_password?(%Peggy.Accounts.User{hashed_password: hashed_password}, password)
