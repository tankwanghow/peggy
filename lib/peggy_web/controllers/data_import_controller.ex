defmodule PeggyWeb.DataImportController do
  ...
  @templates %{
    ...
    "sows" => "ear_tag,breed,dob,status,current_pen,sire_tag,dam_tag,legacy_parity,rfid,notes\n",
    ...
    "weanings" =>
      "sow_ear_tag,weaned_at,weaned_count,avg_wean_weight_g,batch_tag,destination_pen,notes\n",
