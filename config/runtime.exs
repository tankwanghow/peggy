...
#
#     PHX_SERVER=true bin/peggy start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :peggy, PeggyWeb.Endpoint, server: true
end

config :peggy, PeggyWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  config :peggy, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  # is loud rather than silent (would-be password-reset emails getting
  ...
  config :peggy, :mail_from, {"Peggy", mail_from}
end
